                ...
                <div class="owl-carousel">
                    <div class="carousel-item">
                        <div class="carousel-img">
                            <img src="<?php echo get_template_directory_uri(); ?>./img/carousel-1.jpg" alt="Image">
                        </div>
                    ...
                    <div class="carousel-item">
                        <div class="carousel-img">
                            <img src="<?php echo get_template_directory_uri(); ?>/img/carousel-2.jpg" alt="Image">
                        </div>
                        <div class="carousel-text">
                            <h3>Washing & Detailing</h3>
                    ...
                    <div class="carousel-item">
                        <div class="carousel-img">
                            <img src="<?php echo get_template_directory_uri(); ?>/img/carousel-3.jpg" alt="Image">
                        </div>
                        <div class="carousel-text">
                            <h3>Washing & Detailing</h3>
